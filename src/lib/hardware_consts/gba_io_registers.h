...
#define DISPCNT_DISPLAY_FRAME_SELECT (1 << 4)
...
#define DISPCNT_BG_MODE_4 0x4

#define SET_VIDEO_MODE_3() (*((Mem_ptr)(IO_REGISTERS_DISPCNT_ADDR))) = (DISPCNT_BG_MODE_3 | DISPCNT_DISPLAY_BG2)
#define SET_VIDEO_MODE_4() (*((Mem_ptr)(IO_REGISTERS_DISPCNT_ADDR))) = (DISPCNT_BG_MODE_4 | DISPCNT_DISPLAY_BG2)
